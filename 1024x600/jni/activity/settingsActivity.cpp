...
static ZKButton* mbtnSetServerIPPtr;
static ZKEditText* meditTextServerIPPtr;
static ZKButton* mbtnOtherPtr;
static ZKButton* mbtnSetWiFiPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_SETTINGS_btnSetServerIP, onButtonClick_btnSetServerIP,
    ID_SETTINGS_btnOther, onButtonClick_btnOther,
    ID_SETTINGS_btnSetWiFi, onButtonClick_btnSetWiFi,
};
/***************/
...
void settingsActivity::onCreate() {
	Activity::onCreate();
    mbtnSetServerIPPtr = (ZKButton*)findControlByID(ID_SETTINGS_btnSetServerIP);
    ...
    mbtnOtherPtr = (ZKButton*)findControlByID(ID_SETTINGS_btnOther);
    mbtnSetWiFiPtr = (ZKButton*)findControlByID(ID_SETTINGS_btnSetWiFi);
	mActivityPtr = this;
	onUI_init();
