...
void planActivity::onCreate() {
	Activity::onCreate();
    mTextMsgPtr = (ZKTextView*)findControlByID(ID_PLAN_TextMsg);
    mTextMsgTitlePtr = (ZKTextView*)findControlByID(ID_PLAN_TextMsgTitle);
    mWindNotifyPtr = (ZKWindow*)findControlByID(ID_PLAN_WindNotify);
...
void planActivity::videoLoopPlayback(ZKVideoView *pVideoView, int msg, size_t callbackTabIndex) {
