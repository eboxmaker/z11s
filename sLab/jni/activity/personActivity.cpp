...
static ZKTextView* mTextLockRightPtr;
...
void personActivity::onCreate() {
	Activity::onCreate();
    mTextLockRightPtr = (ZKTextView*)findControlByID(ID_PERSON_TextLockRight);
    mTextView1Ptr = (ZKTextView*)findControlByID(ID_PERSON_TextView1);
    mTextMsgPtr = (ZKTextView*)findControlByID(ID_PERSON_TextMsg);
    mTextMsgTitlePtr = (ZKTextView*)findControlByID(ID_PERSON_TextMsgTitle);
    mWindNotifyPtr = (ZKWindow*)findControlByID(ID_PERSON_WindNotify);
...
void personActivity::videoLoopPlayback(ZKVideoView *pVideoView, int msg, size_t callbackTabIndex) {
