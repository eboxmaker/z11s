...
void settingsActivity::onCreate() {
	Activity::onCreate();
    mTextMsgPtr = (ZKTextView*)findControlByID(ID_SETTINGS_TextMsg);
    mTextMsgTitlePtr = (ZKTextView*)findControlByID(ID_SETTINGS_TextMsgTitle);
    mWindNotifyPtr = (ZKWindow*)findControlByID(ID_SETTINGS_WindNotify);
