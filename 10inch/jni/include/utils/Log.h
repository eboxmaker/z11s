...
#define LOGO(...)  __android_log_print(ANDROID_LOG_ERROR,LOG_TAG,"%s:", __FILE__),__android_log_print(ANDROID_LOG_ERROR,LOG_TAG,__VA_ARGS__)
#define LOGE(...)  __android_log_print(ANDROID_LOG_ERROR,LOG_TAG,"%s:", __FILE__),__android_log_print(ANDROID_LOG_ERROR,LOG_TAG,__VA_ARGS__)
